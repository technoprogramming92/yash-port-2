        ...
        <Layout className="pt-0 md:pt-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText
                text="Tax inside out with EA Yash Shah"
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="https://wa.me/+918000315213"
                  target="_blank"
                  className="flex items-center bg-dark text-[#f5f5f5] p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-light  border-2 border-solid border-transparent hover:border-[#f5f5f5] md:p-2 md:px-4 md:text-base"
                >
                  Contact
