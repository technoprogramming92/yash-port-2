    ...
    <>
      ...
      <Layout>
        ...
        <p className="mt-6">
          ...
          have filed your tax return on time. Below are the Tax Payment options.
        </p>
        ...
        <ol className="mt-6 list-decimal" type="1">
          <li>
            ...
            short-term payment plan for up to 180 days on the total amount owed
            up to <strong>$ 100,000</strong>. There is no application form
            required to file or no fees, but interest and any penalties continue
            to accrue until the tax debt is paid in full.
          </li>
          <li>
            <strong>Long term Payment Plan</strong>: Taxpayer can also ask IRS
            for a longer term monthly payment or Installment agreement option if
            the payment period is <strong>longer than 180 days</strong>, paid in
            monthly payments and the amount owed is{" "}
        ...
        <ul className="list-disc">
          ...
          <li>
            File Form 9465 Installment Agreement Request (This is for Long term
            Payment Plan only)
          </li>
        </ul>
        ...
        <p className="mt-6">
          ...
          aren&apos;t eligible to enter into an OIC. Not everyone qualifies for
          an OIC. Taxpayers should use the Offer in Compromise Pre-Qualifier to
          decide if an offer in compromise is right for them.
        </p>
        <p className="mt-6">
        ...
        <p className="mt-6">
          ...
          payment would prevent you from meeting your basic living expenses, IRS
          gives an option to delay your payment until your financial condition
          improves. Delay collection does not mean the debt goes away, it means
          the IRS has determined you cannot afford to pay the debt at this time.
        </p>
        <p className="mt-6">
          To get this benefits, IRS may ask you to compete Collection
          Information Statements (like Form 433-F, Form 433-A or Form 433-B) and
          provide proof of a financial status.
        </p>
        <p className="mt-6">
          Interest and any penalties continue to accrue until the tax debt is
          paid in full. You can call the IRS to request a temporary delay of the
          collection process.
        </p>
