  ...
  return (
    <li className="relative col-span-1 w-full p-4 bg-dark border border-solid border-[#f5f5f5] rounded-2xl">
      ...
      <Link
        href={link}
        target="_blank"
        className="w-full inline-block cursor-pointer overflow-hidden rounded"
      >
        <FramerImage
          src={img}
          alt={title}
      ...
      <Link href={link} target="_blank">
        <h2 className="text-[#f5f5f5] capitalize text-2xl font-bold my-2 hover:underline underline-offset-4 mt-4 xs:text-lg">
          {title}
        </h2>
